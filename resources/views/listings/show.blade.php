<x-layout>
    <a href="/" class="inline-block mt-4 mb-4 ml-4 text-black"><i class="fa-solid fa-arrow-left"></i> Back
    </a>
    <div class="mx-4">
        <x-card class="p-10">
            <div class="flex flex-col items-center justify-center text-center">
                <img class="w-48 mb-6 mr-6"
                    src="{{ $listing->logo ? asset('storage/' . $listing->logo) : 'https://raw.githubusercontent.com/bradtraversy/laragigs/main/_laragigs_theme/images/no-image.png' }}"
                    alt="" />
